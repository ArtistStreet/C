...
unordered_map<string, pair<string, char>> reverseTelexTransform = {
    {"ă", {"a", 'a'}}, {"ắ", {"a", 'a'}}, {"ằ", {"a", 'a'}}, {"ẳ", {"a", 'a'}}, {"ẵ", {"a", 'a'}}, {"ặ", {"a", 'a'}},

    {"â", {"a", 'w'}}, {"ấ", {"a", 'w'}}, {"ầ", {"a", 'w'}}, {"ẩ", {"a", 'w'}}, {"ẫ", {"a", 'w'}}, {"ậ", {"a", 'w'}},

    // {"ê", {"e", 'e'}}, {"ế", {"e", 'e'}}, {"ề", {"e", 'e'}}, {"ể", {"e", 'e'}}, {"ễ", {"e", 'e'}}, {"ệ", {"e", 'e'}},

    {"ô", {"o", 'w'}}, {"ố", {"o", 'w'}}, {"ồ", {"o", 'w'}}, {"ổ", {"o", 'w'}}, {"ỗ", {"o", 'w'}}, {"ộ", {"o", 'w'}},

    {"ơ", {"o", 'o'}}, {"ớ", {"o", 'o'}}, {"ờ", {"o", 'o'}}, {"ở", {"o", 'o'}}, {"ỡ", {"o", 'o'}}, {"ợ", {"o", 'o'}},

    // {"ư", {"u", 'w'}}, {"ứ", {"u", 'w'}}, {"ừ", {"u", 'w'}}, {"ử", {"u", 'w'}}, {"ữ", {"u", 'w'}}, {"ự", {"u", 'w'}}
};
